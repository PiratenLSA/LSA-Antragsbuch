...
\newcommand{\wahlprogramm}[1]{\refstepcounter{wahlprogramm}\addcontentsline{toc}{subsection}{WPA \numberline{\arabic{wahlprogramm}} #1}\textbf{\Large WPA \arabic{wahlprogramm} - #1}\smallskip\\}
...
%%\include{grundsatz}
%%\include{wp_praeambel}
%%\include{wp_datenschutz}
%%\include{wp_transparenz}
%%\include{wp_bildung}
%%\include{wp_demokratie}
%%\include{wp_ip}
%%\include{wp_openaccess}
%%\include{wp_monopol}
%%\include{wp_selbstbestimmung}
%%\include{wp_gesundheit}
%%\include{wp_wirtschaft}
%%\include{wp_sozial}
%%\include{wp_kultur}
%%\include{wp_finanzen}
%%\include{wp_umwelt}
